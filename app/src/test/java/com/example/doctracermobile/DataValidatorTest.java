...
//////////////////////// LENGTH TESTS \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
    ...
    public void shortPassTest(){
        ...
        Assert.assertEquals(lenReply, DataValidator.passwordCheck(password));
    }
...
//////////////////////////// FORBIDDEN CHARACTERS TESTS \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
    ...
    public void bBracketTest(){
        ...
        Assert.assertEquals(symReply, DataValidator.passwordCheck(password));
    }
    ...
    public void correctTest(){
        ...
        Assert.assertEquals(null, DataValidator.passwordCheck(password));
    }
    ...
    public void wrongNumTest(){
        ...
        Assert.assertEquals(numReply, DataValidator.phoneCheck(num));
    }

    @Test
    public void correctNumTest(){
        String num = "+7 919 103-33-23";
        Assert.assertEquals(null, DataValidator.phoneCheck(num));
    }
